    ...
    public CustomResponseEntity<Venta> findById(Integer id) {
        ...
        try {
            ...
            if (rs.next()) {
                ...
                rs.getInt("ID_VENTA"),
                new Cliente(rs.getInt("CLIENTE_ID"),bgdecimal,"","","","",""),
        ...
        try{
            ...
            while(rs.next()){
                Venta v = new Venta(rs.getInt(1),
                        new Cliente(rs.getInt(7),rs.getBigDecimal(8),rs.getString(9),rs.getString(10),rs.getString(11),rs.getString(12),rs.getString(13))
